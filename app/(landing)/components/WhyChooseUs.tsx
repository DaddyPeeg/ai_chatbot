...
const WhyChooseUs = () => {
  ...
  return (
    <section className="h-[calc(100dvh_-_4rem)] w-full flex relative">
          ...
          <div className="h-full justify-center flex flex-col lg:flex-row">
            ...
            <div className="lg:h-full lg:flex-1">
              <div className="lg:h-full lg:flex gap-4 grid grid-cols-1 lg:flex-col lg:max-w-md lg:ml-auto">
                <div className="border lg:mt-8 rounded-md flex bg-white/15 backdrop-blur-xl items-center lg:py-4 lg:px-4 py-2 px-2">
